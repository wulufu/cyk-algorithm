...
This file can also be imported a module to gain access to the CFG class for
...
class CFG:
    ...
    def __init__(self, rules: list[str]) -> None:
        ...
        Each rule must be of the form "A -> BC" or "A -> a", where 'A', 'B',
        and 'C' are variables, and 'a' is a terminal. Optionally, two or more
        rules with the same left-hand side can be combined into one string
        using the form "A -> BC | a".
