...
# Returns a dictionary containing rules generated by lines in the CFG file, or
# returns None if the file does not contain a valid CFG in CNF. To be valid,
# each line in the file must be of the form A -> BC or A -> a, where A, B, and
# C are non-terminal symbols, and a is a terminal symbol.
def generate_rules():
    rules = {}
